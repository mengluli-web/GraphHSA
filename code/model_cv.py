...
class GraphHSA(BaseModel):
    def __init__(self, 
        ...
        #self.symptom_embedding2 = torch.nn.Linear(self.emb_dim*2, self.emb_dim)
        #self.drug_embedding2 = torch.nn.Linear(self.emb_dim*2, self.emb_dim)
    ...
    def forward(self, symptoms: torch.LongTensor, drug: torch.LongTensor,
        ...
        #symptom_embeddings = self.symptom_embedding(symptoms)
        #drug_embeddings = self.drug_embedding(drug)
        ...
        symptom_i_list = self._interaction_aggregation(symptom_embeddings, symptom_neighbors_emb_list)
        drug_i_list = self._interaction_aggregation(drug_embeddings, drug_neighbors_emb_list)
        ...
        #print(loss_multi)
        #combined_emb = torch.cat([embeds_pro, embeds_gcn], dim=1)
        ...
        return score, combined_emb, loss_multi, score_pro, score_gcn
